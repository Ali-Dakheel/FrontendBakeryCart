...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-sky text-white hover:bg-sky-dark shadow-sm hover:shadow-md",
        destructive:
        ...
        outline:
          "border border-navy/20 bg-white text-navy hover:bg-cream-dark hover:border-navy/30 hover:shadow-sm dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-navy text-white hover:bg-navy-light shadow-sm hover:shadow-md",
        ghost:
          "text-navy hover:bg-cream-dark hover:text-navy dark:hover:bg-accent/50",
        link: "text-sky underline-offset-4 hover:underline hover:scale-100",
      },
      size: {
